...
app.layout = dbc.Container(
    dbc.Row([
        dbc.Col([
            html.Div([
                html.H1("Uma análise de dados sobre"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H6(style={"color": "#adfc92"}, id="casos-recuperados-text"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H6(style={"color": "#389fd6"}, id="casos-confirmados-text"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H6(style={"color": "#DF2935"}, id="obitos-text"),
        ...
        ], md=7, style={"padding-right": "0px", "padding-left": "0px", })
...
def display_status(date, location):
    ...
    return (recuperados_novos, acompanhamentos_novos, casos_acumulados, casos_novos, obitos_acumulados, obitos_novos)
